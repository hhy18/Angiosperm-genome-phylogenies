...
if __name__ == "__main__":
	...
	for i in os.listdir(inDIR):
		...
		com = "Gblocks "+inDIR+i+" -t=c -b1="+str(min_col)+" -b2="+str(min_col)
		com += " -b3=8 -b4=10 -b5=h" #-t=d for DNA
		# print(com)
		# os.system(com)
			
		# remove empty columns produced by Gblocks
		phyutility = "java -jar /data/01/user102/biosofeware/phyutility/phyutility.jar"
		cmd = "{phyutility} -aa -clean 0.00001 -in ".format(phyutility=phyutility)+inDIR+i
