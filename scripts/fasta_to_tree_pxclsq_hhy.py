...
from fasttree_wrapper_hhy import fasttree
from raxml_wrapper import raxml
# from raxml_bs_wrapper import raxml_bs
from seq import read_fasta_file
from iqtree_wrapper import iqtree_bs

NUM_SEQ_CUTOFF = 10 # Use different alignment and tree inference tools
